...
if __name__ == "__main__":
    start = time.time()
    data_path = '/home/Data/data/MNIST/raw_csv'
    trainDataArr, trainLabelArr = loadData(data_path + '/mnist_train.csv')
    testDataArr, testLabelArr = loadData(data_path + '/mnist_test.csv')

    # 计算测试集正确率
    accur = model_test(
        trainDataArr, trainLabelArr, 
        testDataArr, testLabelArr, 25)
